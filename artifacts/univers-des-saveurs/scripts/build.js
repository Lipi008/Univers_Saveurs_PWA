...
const metroPort = Number.parseInt(process.env.EXPO_BUILD_METRO_PORT || '8099', 10);
...
function exportWeb(expoPublicDomain, expoPublicReplId) {
  return new Promise((resolve, reject) => {
    console.log('Exporting installable web app...');
    const child = spawn(
      'pnpm',
